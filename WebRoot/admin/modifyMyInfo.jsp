    ...
    <td>
      ...
      <tr>
        ...
        <table width="100%" border="0" align="l" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr>
            <td width="100%" height="26" background="images/tab_14.gif" class="STYLE1" colspan="2"><div align="center" class="STYLE2 STYLE1">请修改学生信息</div></td>
          </tr>
            ...
            <div align="left" class="STYLE2 STYLE1">
                &nbsp;&nbsp;<s:property value="#attr.admin.username"/>
            </div></td>           
    		</tr>
    		<tr>
             ...
             <td height="18" bgcolor="#FFFFFF" class="STYLE2">
              <div align="left" class="STYLE2 STYLE1">
                 &nbsp;&nbsp;<input type="text" name="admin.realname" value="<s:property value='#attr.admin.realname'/>">
              </div>
             </td>          
    		</tr>
    		<tr>
