...
//alert("你好")
 ...
 <s:form action="Student/studentmanager!addStudent" method="post" enctype ="multipart/form-data">  
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr>
            <td width="100%" height="26" background="images/tab_14.gif" class="STYLE1" colspan="2">
                <div align="center" class="STYLE2 STYLE1">请填写学生信息</div>
            </td>
          </tr>
            ...
            <div align="left" class="STYLE2 STYLE1">
                &nbsp;&nbsp;<input type="text" onblur="load()" id="studentno" name="student.studentno" ><span id="status"></span>
            </div></td>           
    		</tr>
    		<tr>
             ...
             <td height="18" bgcolor="#FFFFFF" class="STYLE2">
              <div align="left" class="STYLE2 STYLE1">
                 &nbsp;&nbsp;<input type="text" name="student.realname" value="">
              </div>
             </td>          
    		</tr>
    		<tr>
             ...
             <td height="18" bgcolor="#FFFFFF" class="STYLE2">
              <div align="left" class="STYLE2 STYLE1">
                 &nbsp;&nbsp;<input type="text" name="student.nativeplace" value="">
              </div>
             </td>          
    		</tr>
    		<tr>
             ...
             <td height="18" bgcolor="#FFFFFF" class="STYLE2">
              <div align="left" class="STYLE2 STYLE1">
                 &nbsp;&nbsp;
                 <sx:datetimepicker name="student.birthday" toggleType="explode" type="date"
                          language="utf-8" displayFormat="yyyy-MM-dd"/>
              </div>
             </td>          
    		</tr>
    		<tr>
    		...
    		<tr>
             ...
             <td height="18" bgcolor="#FFFFFF" class="STYLE2">
              <div align="left" class="STYLE2 STYLE1">
                 &nbsp;&nbsp;<input type="text" name="student.tel" value="">
              </div>
             </td>          
    		</tr>
    		<tr>
