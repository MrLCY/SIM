...
<script type="text/javascript">
   ...
   function deleteTeacher(id){
    ...
    window.location.href = 'Teacher/teachermanager!deleteTeacher?teacher.id='+id;
    }
   }
</script>
</head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1001" background="images/tab_05.gif"><img src="images/311.gif" width="16" height="16" /> <span class="STYLE4">维护教师信息</span></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <s:iterator id="teacher" var="teacher" value="#attr.teacherlist">
        
          <tr>
    		<td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1"><s:property value="#teacher.teacherid"/></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1"><s:property value="#teacher.realname"/></div></td>            
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1"><s:property value="#teacher.username"/></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1"><s:property value="#teacher.password"/></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="Student/studentmanager!getOneStudent?student.id=${teacher.id}">查看</a></div></td> 
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="Student/studentmanager!getStudentToUpdate?student.id=${teacher.id}">修改</a></div></td> 
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="./admin/teacherAdd.jsp">添加</a></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="javascript:void(0)" onclick="deleteTeacher(${teacher.id})">删除</a>
		    </div></td> 
    		</tr>
    		</s:iterator>
          <!--<tr>
