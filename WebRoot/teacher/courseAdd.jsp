...
//alert("你好")
 ...
 <s:form action="Course/coursemanager!addCourse" method="post" >  
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr>
            <td width="100%" height="26" background="images/tab_14.gif" class="STYLE1" colspan="2">
                <div align="center" class="STYLE2 STYLE1">请填课程信息</div>
            </td>
          </tr>
          
    		<tr>
    		<td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">课程名称</div></td>
            <td height="18" bgcolor="#FFFFFF" class="STYLE2">
            <div align="left" class="STYLE2 STYLE1">
                &nbsp;&nbsp;<input type="text" onblur="load()" name="course.coursename" ><span id="status"></span>
            </div></td>           
    		</tr>
