...
<script type="text/javascript">
   ...
   function deleteStudent(id){
   	if(confirm('您确定要删除吗?将会从课程中删除此学生')){
    ...
    window.location.href = 'Teacher/teachermanager!deleteStudentFromCourse?student.id='+id;
    }
   }
</script>
</head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1001" background="images/tab_05.gif"><img src="images/311.gif" width="16" height="16" /> <span class="STYLE4"><s:property value="#course.coursename"/>维护学生信息</span></td>
      ...
      <tr>
        ...
        <s:iterator id="stu" var="stu" value="#attr.stulist">
          ...
          <tr>
            ...
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="Course/coursemanager!addStudentToCourse?student.id=${stu.id}">添加</a></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
