...
<script type="text/javascript">
   ...
   function deleteCourse(id){
   	if(confirm('此操作会删除课程中的学生和课程对应关系，您确定要删除该门课程吗?')){
    ...
    window.location.href = 'Course/coursemanager!deleteCourseByTeacher?course.id='+id;
    }
   }
</script>
</head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1001" background="images/tab_05.gif"><img src="images/311.gif" width="16" height="16" /> <span class="STYLE4">维护课程信息</span></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <s:iterator id="course" var="course" value="#attr.courselist">
        
          <tr>
    		<td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1"><s:property value="#course.coursename"/></div></td>
            ...
            <a href="Teacher/teachermanager!getStudentInCourse?course.id=<s:property value="#course.id"/>">查看班级</a></div></td> 
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="Student/studentmanager!getStudentToUpdate?student.id=${stu.id}">修改</a></div></td> 
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="Course/coursemanager!getStudentNoInCourse?course.id=<s:property value="#course.id"/>">添加学生</a></div></td>
            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">
            <a href="javascript:void(0)" onclick="deleteCourse(${course.id})">删除</a>
		    </div></td> 
    		</tr>
    		</s:iterator>
          <!--<tr>
